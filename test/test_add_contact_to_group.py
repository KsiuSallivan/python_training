...
# можно получить полный список групп, получить список групп, в которые входит контакт, и сравнить размер
# а если размер не совпал, тогда можно сделать следующий шаг, выкинуть из полного списка групп те,
# в которые входит контакт, и получим список групп, в которые он не входит
